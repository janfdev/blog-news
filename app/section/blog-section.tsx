    ...
    <section className="py-20">
      <div className="container mx-auto flex flex-col items-center">
        <div className="text-center">
          <h2 className="mx-auto  text-3xl font-semibold text-pretty md:text-4xl lg:max-w-3xl">
            {heading}
          </h2>
        </div>
        ...
        <div className="grid gap-y-10 sm:grid-cols-12 sm:gap-y-12 md:gap-y-16 lg:gap-y-20">
          {posts.map((post) => (
            <Card
              key={post.id}
              className="order-last border-0 bg-transparent md:px-0 px-5 shadow-none sm:order-first sm:col-span-12 lg:col-span-10 lg:col-start-2"
            >
